        ...
        <List>
          <div style={{ padding: "8px 16px" }}>
            <Link to="/" style={{ display: "flex" }}>
              ...
              <StyledTextNav onClick={handleDrawerClose}>Inicio</StyledTextNav>
            </Link>
          </div>
          {!isLoogedIn ? (
            <div style={{ padding: "8px 16px" }}>
              <Link to="/auth/login" style={{ display: "flex" }}>
                ...
                <StyledTextNav>Iniciar Sesión</StyledTextNav>
              </Link>
            </div>
          ) : (
            <p></p>
          ...
          {isLoogedIn ? (
            <div style={{ padding: "8px 16px" }}>
              <Link to="/ofertas" style={{ display: "flex" }}>
                ...
                <StyledTextNav>Ofertas</StyledTextNav>
              </Link>
            </div>
          ) : (
            <p></p>
          ...
          {isLoogedIn ? (
            <div style={{ padding: "8px 16px" }}>
              <Link to="/perfil" style={{ display: "flex" }}>
                ...
                <StyledTextNav>Perfil</StyledTextNav>
              </Link>
            </div>
          ) : (
            <p></p>
          ...
          {isLoogedIn ? (
            <div style={{ padding: "8px 16px",cursor:"pointer"}} onClick={handleLogout}>
              <div style={{ display: "flex" }}>
                ...
                <StyledTextNav>Salir</StyledTextNav>
              </div>
            </div>
          ) : (
            <p></p>
